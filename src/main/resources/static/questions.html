...
<head>
    ...
    <title>Questions | jBravo pizza</title>
    <!-- Fonts Here-->
...
<body>
                ...
                <div class="top_nav" id="navbar">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="logo">
                                    <a href="index.html" title="jBravo Pizza"><img src="images/jBravo_logo_2.png" alt="jBravo Pizza"></a>
                                </div>
                                <div class="nav_manu">
                                    <div class="Menu_list">
                                        <ul class="menu">
                                            ...
                                            <li><a href="menu.html" class="trans">Order</a></li>
                                            <li><a href="login.html" class="trans">Sign-In</a></li>
                                            <li><a href="login.html" class="trans">Sign-up</a></li>
                                        </ul>
                                    </div>
                                    <div class="Cart">
                            ...
                            <div class="Questions_contact">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <p>You will enter the coupon code during checkout, after adding the items you wish to purchase to your cart. Enter the code into the box labelled “Coupon #” and click “Apply Coupon” on the “Order Review” page. </p>
                                    </li>
                                    <li>
                                        <h3>My online order did not go through, however my credit card was still charged. How do I get a refund?</h3>
                                        <p>When you enter your credit card information incorrectly, your order cannot be processed. For security purposes, your bank will place a hold and you will see a pending amount reflect on your account. Within 3-5 business days, depending on your bank, the hold on that amount will drop from your account.</li>
                                    <li>
                                        <h3>I can’t find my coupon on the hot deals page. Where’s it at?</h3>
                                        <p>To use a coupon, add the corresponding items to your cart. Then, on the order review page enter the Offer Code # found on the coupon into the box labeled Coupon #. After entering the code click “ADD TO ORDER”</p>
                                    </li>
                                    <li>
                                        <h3>How do I create a half and half pizza?</h3>
                                        <p>Unfortunately, we are unable to do Half and Half specialty pizzas. However, you can create a non-specialty half and half pizza by clicking create your own on the pizzas page. Once on the create your own pizza page, click ingredients and you will be able to add sauce, toppings, or cheese to individual sides of the pizza.</p>
                                    </li>
                                    <li>
                                        <h3>Does your cheese include animal rennet?</h3>
                                        <p>Our cheese is 100% whole milk mozzarella made in the sunny Central Valley of California. Our mozzarella cheese is made using microbial rennet (non-animal sourced).</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 quick_links"><div class="title">Quick Links</div>
                                    ...
                                    <div class="main_cnt">
                                        <ul>
                                            ...
                                            <li><a href="questions.html" class="trans" title="Questions">Questions</a></li>
                                            <li><a href="contactus.html" class="trans" title="Contacts">Contacts</a></li>
                                            <li><a href="login.html" class="trans" title="Sign-In">Sign-In</a></li>
                                            <li><a href="login.html" class="trans" title="Sign-up">Sign-up</a></li>
    ...
    <p>© <a href="index.html" class="trans" title="jBravo Pizza">jBravo Pizza</a> <script type="text/javascript">document.write(new Date().getFullYear());</script>, All rights reserved By Mama </p>                </div>
            </div>
        </footer>
