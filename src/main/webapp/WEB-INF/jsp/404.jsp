                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="content-404">
                            ...
                            <h6>Sorry, We couldn't find the page you're looking for.</h6>
                            <div class="btn_cmpted home-btn">
                                    <a href="index" class="trans red_btn hvr-float-shadow" title="Home">Go To Home</a>
                                </div>
